...
export default function AppMain(){
	...
	_this.els_tooperate={
		dialog_group_new,
		list_group:_this.shadowRoot.getElementById("list-group"),
...
AppMain.prototype.reactiverender = function(rd_delta){
	...
	el_group.reactiverender({name: rd_delta.cur_group});
	if(rd_delta.groups) item_group.reactiverender_for(rd_delta.groups, 
		function(rd_group){
